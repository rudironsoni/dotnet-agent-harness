...
public static class RecommendationEngine
{
    private static readonly RecommendationRule[] Rules =
    {
        ...
        new("foundation", CatalogKinds.Command, "dotnet-agent-harness-bootstrap", 95, "Bootstrap the repo before deeper work so agent targets, state, and prompts are aligned"),
        new("foundation", CatalogKinds.Command, "init-project", 90, "Repo initialization analysis should happen before deeper work"),
        new("foundation", CatalogKinds.Command, "dotnet-agent-harness-graph", 54, "Reference graphs help explain command, skill, and persona relationships"),
