...
public static class RuntimeCommandCatalog
{
    ...
    [
        ...
        new() { Name = "install-agent", Usage = "install-agent [same options as bootstrap]" },
        ...
        new() { Name = "init", Usage = "init [--format text|json] [--limit N] [--no-save]" },
        ...
        new() { Name = "prepare-message", Usage = "prepare-message <request> [--persona id] [--target path] [--platform generic|codexcli|claudecode|opencode|geminicli|copilot|antigravity|factorydroid] [--limit N] [--write-evidence] [--evidence-id id] [--format text|json|prompt]", CommandDocPath = ".rulesync/commands/dotnet-agent-harness-prepare-message.md" },
