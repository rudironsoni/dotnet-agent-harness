...
This skill guides how to create effective integration tests in ASP.NET Core, using `WebApplicationFactory<T>` and `TestServer` to test complete HTTP request/response flows.
