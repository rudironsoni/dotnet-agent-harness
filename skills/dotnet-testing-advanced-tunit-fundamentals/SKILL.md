...
This skill covers TUnit new-generation .NET testing framework introduction basics, from framework features to actual project creation and test writing.
...
TUnit's biggest difference from traditional testing frameworks is using Source Generator to complete test discovery at **compile time**:
