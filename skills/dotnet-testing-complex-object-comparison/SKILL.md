...
This skill focuses on complex object comparison scenarios in .NET testing, using AwesomeAssertions' `BeEquivalentTo` API to handle various advanced comparison needs.
