...
/// <summary>
/// Complex object comparison patterns and examples
/// </summary>
public class ComparisonPatterns
{
    ...
    #region Pattern 1: Basic Deep Object Comparison

    [Fact]
    public void Pattern1_DeepObjectFullComparison_Example()
    {
    ...
    #region Pattern 2: Excluding Dynamic Fields

    [Fact]
    public void Pattern2_ExcludeTimestampsAndAutoGeneratedFields_Example()
    {
        ...
        updated.Should().BeEquivalentTo(original, options =>
            options.Excluding(o => o.UpdatedAt)      // Auto-updated timestamp
                   .Excluding(o => o.Status)         // Status may change
        );
    ...
    #region Pattern 3: Nested Object Exclusion

    [Fact]
    public void Pattern3_ExcludeNestedObjectTimeFields_Example()
    {
        var expected = new Order
        {
            Id = 1,
    ...
    #region Pattern 4: Circular Reference Handling

    [Fact]
    public void Pattern4_HandleCircularReferenceStructures_Example()
    {
    ...
    #region Pattern 5: Selective Property Comparison

    [Fact]
    public void Pattern5_OnlyCompareKeyProperties_Example()
    {
        var expected = new Order
        {
            Id = 1,
    ...
    #region Pattern 6: Collection Order Control

    [Fact]
    public void Pattern6_CollectionOrderComparisonControl_Example()
    {
    ...
    #region Pattern 7: Large Data Sampling Verification

    [Fact]
    public void Pattern7_LargeDataSamplingVerification_Example()
    {
    ...
    #region Pattern 8: Entity Framework Entity Comparison

    [Fact]
    public void Pattern8_EFEntityComparison_Example()
    {
        var expected = new Order
        {
            Id = 1,
        ...
        actual.Should().BeEquivalentTo(expected, options =>
            options.ExcludingMissingMembers()      // Exclude extra EF properties
                   .Excluding(o => o.CreatedAt)
                   .Excluding(o => o.UpdatedAt)
                   .Excluding(o => o.AuditInfo)    // Possible navigation property
        );
    }

    #endregion

    #region Pattern 9: AssertionScope Batch Verification

    [Fact]
    public void Pattern9_BatchVerifyMultipleObjects_Example()
    {
        ...
        using (new AssertionScope())
        {
            foreach (var order in orders)
            {
                ...
                order.CustomerName.Should().NotBeNullOrEmpty("Customer name cannot be empty");
                order.TotalAmount.Should().BeGreaterThan(0, "Total amount must be greater than 0");
    ...
    #region Pattern 10: Error Message Optimization

    [Fact]
    public void Pattern10_ProvideMeaningfulErrorMessages_Example()
    {
        var expected = new Order
        {
            Id = 1,
        ...
        actual.Should().BeEquivalentTo(expected, options =>
            options.Excluding(o => o.CreatedAt)
                   .Because("CreatedAt is system auto-generated timestamp")
                   .Excluding(o => o.UpdatedAt)
                   .Because("UpdatedAt changes with order updates")
        );

        actual.Status.Should().Be(expected.Status,
            "Because new orders default status should be Pending");
    }
