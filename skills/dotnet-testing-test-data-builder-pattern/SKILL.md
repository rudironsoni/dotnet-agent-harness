...
1. **Fixed test data problem**: Object Mother provides fixed test objects, difficult to adjust for specific test scenarios
2. **Unclear test intent**: When creating objects directly, test focus is easily obscured by large amounts of attribute settings
